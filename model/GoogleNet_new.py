...
class GoogleNetNew:
  ...
  def GoogLeNet():
        ...
        X = Conv2D(filters=64, kernel_size=(5, 5), strides=1, padding='same', activation='relu')(input_layer)  
        ...
        # Extra network 1:
        X1 = AveragePooling2D(pool_size=(2, 2), strides=2)(X)
        ...
        # model
        model = Model(inputs=input_layer, outputs=age_output, name='GoogleNet')
